...
ext_module_kmer = declare_cython_extension( "hg38genome.kmers.kmer_reader", use_math=False, use_openmp=False , include_dirs=my_include_dirs )
...
setup(
    ...
    url = "https://github.com/kylessmtih/hg38genome",
    ...
    packages = find_namespace_packages(include=["hg38genome", "hg38genome.*"]),
    package_data={'hg38genome': ['*.pxd', '*.pyx', '*.c', '*.h', '*.h5', '*.bed.gz', '*.parquet'],
